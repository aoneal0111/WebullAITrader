...
class SessionBootstrapPolicy:
 version:str="session_bootstrap_policy_v1";enabled:bool=False;strict_validation:bool=True;metadata:Mapping[str,JSONValue]=field(default_factory=dict)
