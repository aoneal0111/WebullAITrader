...
SYMBOL_INTELLIGENCE_SEC_CANONICAL_KEYS = (
    ...
    "ATLAS_SYMBOL_INTELLIGENCE_SEC_D3_DIAGNOSTICS_ROOT",
    "ATLAS_SYMBOL_INTELLIGENCE_SEC_D3_DIAGNOSTICS_SESSION_ID",
)
...
PAPER_CATALYST_NEWS_DOTENV_KEYS = (
    "ATLAS_PAPER_CATALYST_NEWS_ENABLED",
)
