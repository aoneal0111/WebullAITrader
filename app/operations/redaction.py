...
SENSITIVE=frozenset(("authorization","api_key","app_key","api_secret","app_secret","access_token","refresh_token","password","cookie","set-cookie","signature","private_key","account_id","account_number","x-app-key","x_app_key","x-signature","x_signature","x-signature-nonce","x_signature_nonce","x-access-token","x_access_token","signed_headers"))
