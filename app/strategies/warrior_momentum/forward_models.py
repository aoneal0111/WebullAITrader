...
class CaptureRecordType(StrEnum):
    ...
    SHADOW_LATCHED_PLAN = "SHADOW_LATCHED_PLAN"
    SHADOW_LATCHED_TRANSITION = "SHADOW_LATCHED_TRANSITION"
...
class ForwardTransition(StrEnum):
    ...
    PAPER_EXIT_WORKING = "PAPER_EXIT_WORKING"
    PAPER_EXIT_REQUIRED = "PAPER_EXIT_REQUIRED"
    PAPER_POSITION_CONTRADICTION = "PAPER_POSITION_CONTRADICTION"
